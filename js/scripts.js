(function($) {
    $(document).ready(function() {
        ...
        // PAGE TRANSITION - Disabled for better performance
        // Links now navigate directly without delay


    });
    // END DOCUMENT READY

    // DATA BACKGROUND IMAGE - Optimized selector
    $("[data-background]").each(function() {
        var bg = $(this).data("background");
        if (bg.match(/\.(jpg|jpeg|png|gif|webp|svg)$/i)) {
    ...
    // MAIN SLIDER - Optimized for performance
